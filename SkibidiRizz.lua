...
local Window = Fluent:CreateWindow({
    Title = "vital.wtf | Version 0.7.2",
    SubTitle = "Apocalypse Rising 2",
    TabWidth = 160,
...
function boxBase:Update()
    ...
    if ESP.Tracers then
        ...
        if Vis6 and distance < 1250 then
...
local function ToggleNoSpread(enabled)
    ...
    for i, v in pairs(getgc(true)) do
        if type(v) == 'table' and rawget(v, 'Spread') then
            setreadonly(v, false)
            for param, value in pairs(spreadParams) do
                v[param] = enabled and value or nil
            end
        end
    end
...
__     __                ____  _    _ _     _     _ _   ____            _       _   
\ \   / /__ _ __ _   _  / ___|| | _(_) |__ (_) __| (_) / ___|  ___ _ __(_)_ __ | |_ 
 \ \ / / _ \ '__| | | | \___ \| |/ / | '_ \| |/ _` | | \___ \ / __| '__| | '_ \| __|
  \ V /  __/ |  | |_| |  ___) |   <| | |_) | | (_| | |  ___) | (__| |  | | |_) | |_ 
   \_/ \___|_|   \__, | |____/|_|\_\_|_.__/|_|\__,_|_| |____/ \___|_|  |_| .__/ \__|
                 |___/                                                   |_|        
